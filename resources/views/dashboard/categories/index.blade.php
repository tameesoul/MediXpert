@extends('layouts.dashboard')
  ...
  <div class="mb-4">
    ...
    <a href="{{route('dashboard.categories.trash')}}" class="btn btn-larg btn-outline-danger">trashes</a>
</div>
  ...
  <table class="table table-dark">
    ...
    <tbody>
        <tr>
          ...
          <td>{{$category->products_numbers}}</td>
          <td>{{$category->status}}</td>
          <td>{{$category->created_at}}</td>
          <td>
                <a href="{{route('dashboard.categories.edit',$category->id)}}" class="btn btn-larg btn-outline-primary">edit</a>
          </td>
          <td>
